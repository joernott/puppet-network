...
class network::hiera {
  ...
  $network_alias          = lookup('network::alias', Optional[Hash], 'deep', undef)
  $network_alias_range    = lookup ('network::alias_range', Optional[Hash], 'deep', undef)
  $network_bond           = lookup('network::bond', Optional[Hash], 'deep', undef)
  $network_bond_bridge    = lookup('network::bond_bridge', Optional[Hash], 'deep', undef)
  $network_bond_dynamic   = lookup('network::bond_dynamic', Optional[Hash], 'deep', undef)
  $network_bond_slave     = lookup('network::bond_slave', Optional[Hash], 'deep', undef)
  $network_bond_static    = lookup('network::bond_static', Optional[Hash], 'deep', undef)
  $network_bridge         = lookup('network::bridge', Optional[Hash], 'deep', undef)
  $network_bridge_dynamic = lookup('network::bridge_dynamic', Optional[Hash], 'deep', undef)
  $network_bridge_static  = lookup('network::bridge_static', Optional[Hash], 'deep', undef)
  $network_if             = lookup('network::if', Optional[Hash], 'deep', undef)
  $network_if_bridge      = lookup('network::if_bridge', Optional[Hash], 'deep', undef)
  $network_if_dynamic     = lookup('network::if_dynamic', Optional[Hash], 'deep', undef)
  $network_if_promisc     = lookup('network::if_promisc', Optional[Hash], 'deep', undef)
  $network_if_static      = lookup('network::if_static', Optional[Hash], 'deep', undef)
  $network_route          = lookup('network::route', Optional[Hash], 'deep', undef)
